          ...
          >
            ...
            <div className="flex items-center gap-4 mb-4 relative z-10">
              ...
              <div>
                ...
                <p className="text-yellow-500/80 text-[8px] font-bold uppercase tracking-widest">
                  Backend Connectivity Limitation
                </p>
              </div>
            </div>
            ...
            <div className="space-y-3 text-slate-300 leading-relaxed relative z-10 mb-6">
              {type === 'login' ? (
                <div className="bg-yellow-500/10 p-4 rounded-2xl border border-yellow-500/20">
                  ...
                  <p className="text-xs text-slate-400">
                    Due to backend limits, VARK Questionnaire, Quiz and Feedback data
                    won't be saved. Focus on the{' '}
                    <span className="text-white">Learning Paths</span> and{' '}
                    <span className="text-white">AR Features</span>!
                  </p>
                </div>
              ) : (
                <div className="bg-black/40 p-4 rounded-2xl border border-white/5 space-y-2">
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-xs">
                      ...
                      blank. They aren't connected to the server yet.
                    </p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="mt-1">
              ...
              >
                ...
                <span className="text-[8px] text-yellow-500/60 font-bold group-hover:text-yellow-400">
                  Google Form Link
                </span>
              </a>
